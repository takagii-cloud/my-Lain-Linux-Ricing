...
Column {
    ...
    Item {
            ...
            delegate: ItemDelegate {
                ...
                contentItem: Text {
                    ...
                    color: selectUser.highlightedIndex === index
                        ? (root.palette.highlight.hslLightness >= 0.7 ? "#444" : "white")
                        : (root.palette.window.hslLightness >= 0.8
                            ? (root.palette.highlight.hslLightness >= 0.8 ? "#444" : root.palette.highlight)
                            : "white")
        ...
        Item {
            ...
            property color iconColor: selectUser.popup.visible
                                      ? root.palette.highlight
                                      : (iconMouseArea.containsMouse
                                         ? Qt.lighter(root.palette.highlight, 1.15)
                                         : (username.activeFocus
                                            ? root.palette.highlight
                                            : root.palette.text))

            Image {
                id: usernameIconSource
                anchors.centerIn: parent
            ...
            ColorOverlay {
                anchors.fill: usernameIconSource
                source: usernameIconSource
            ...
            MouseArea {
                ...
                onClicked: {
                    if (selectUser.popup.visible) {
                        selectUser.popup.close()
                    } else {
